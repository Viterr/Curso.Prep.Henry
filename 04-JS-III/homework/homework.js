...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  else if (arguments.length==1) result = arguments[0]
  else result = 0;
  return result
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let result = array.filter(mes =>  mes === 'Enero'  || mes === 'Marzo' || mes === 'Noviembre')
...
function breakStatement(numero) {
  ...
  return numero == i ? 'Se interrumpió la ejecución' : result
}
